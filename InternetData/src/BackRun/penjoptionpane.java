...
public class penjoptionpane 
{
    Runtime runtime = Runtime.getRuntime();
    Process proc=null;
    pentest obj = new pentest();
    
    public penjoptionpane() {
   ...
   int n= JOptionPane.showConfirmDialog(jd, "YOU ARE TRY Access USB\n"+"Click YES For removing USB\n"+"Click NO Loggoff\n","Warning", JOptionPane.YES_NO_OPTION);
    ...
    public class CountDownTimerDialog extends JDialog {
        ...
        public CountDownTimerDialog(JDialog parent, boolean modal, int seconds) {
            ...
            JLabel message = new JLabel("System Will Be log off After CountDown Complte");
