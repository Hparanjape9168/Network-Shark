 ...
 *
 */
public class BarChart3DDemo3Stud extends ApplicationFrame {
 
    public JPanel studpanel= new JPanel();
    /**
     * Creates a new demo.
     *
     * @param title  the frame title.
     */
    public BarChart3DDemo3Stud(final String title) throws ClassNotFoundException, SQLException {
   ...
   private CategoryDataset createDataset() throws ClassNotFoundException, SQLException
   {
      ...
      con = DriverManager.getConnection(connect.url, connect.userName, connect.Password);
       ...
       String qr= "SELECT * FROM student_work_detail where ENROLLMENT_NUMBER='"+user.tlogin+"'";
        ...
        int i=0;
             while(rs.next())
            {
              dataset.addValue(rs.getDouble("WEEK_1"), "WEEK_1", ""); 
              dataset.addValue(rs.getDouble("WEEK_2"), "WEEK_2", "");
              dataset.addValue(rs.getDouble("WEEK_3"), "WEEK_3", "");
              dataset.addValue(rs.getDouble("WEEK_4"), "WEEK_4", ""); 
              dataset.addValue(rs.getDouble("WEEK_5"), "WEEK_5", ""); 
           }
...
//        dataset.addValue(10.0, "Series 4", "Category 3");  
    ...
    private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        final JFreeChart chart = ChartFactory.createBarChart3D(
            "Internet Data Usage",      // chart title
    ...
    public static void main(final String[] args) throws ClassNotFoundException, SQLException {
        ...
        final BarChart3DDemo3Stud demo = new BarChart3DDemo3Stud("Network Usage Entire Month For User");
                //final BarChart3DDemo3Stud demo1 = new BarChart3DDemo3Stud("Network Usage Entire Month For Labs ");
        //demo1.pack();
        demo.pack();
