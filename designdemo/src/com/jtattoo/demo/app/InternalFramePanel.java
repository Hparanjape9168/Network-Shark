...
import org.jfree.chart.demo.PieChart3DDemo1;
import org.jfree.chart.demo.BarChart3DDemo3Lab;
/*
...
public class InternalFramePanel extends JPanel {
    ...
    //   BarChart3DDemo3 obj2=null;    //display graph
       PieChart3DDemo1 obj3=null;  //display graph
       BarChart3DDemo3Lab obj4=null;
 ...
 /*   public JInternalFrame createInternalFrame(Icon icon, Integer layer, int width, int height) {
       ...
       // jif.setContentPane(new ImageScroller(icon1, 0, windowCount));
         try
        {
         obj2=new BarChart3DDemo3("Lab_usage"); 
        }
        catch(Exception ex)
        {
            ex.printStackTrace();
        }
        jif.add(obj2.getchart());
        windowCount++;
  ...
  */
     public JInternalFrame createInternalFrame1(Icon icon, Integer layer, int width, int height) {
        ...
        if (!windowTitleField.getText().equals("Internal-Frame")) {
            ...
            jif = new JInternalFrame("Network Usage Graph Analysis");
        }
       ...
       // jif.setContentPane(new ImageScroller(icon1, 0, windowCount));
         try
        {
         obj3=new PieChart3DDemo1("data_usage"); 
        }
        catch(Exception ex)
        {
            ex.printStackTrace();
        }
        jif.add(obj3.getchart());
        windowCount++;
     ...
     public JInternalFrame createInternalFrame2(Icon icon, Integer layer, int width, int height) {
        JInternalFrame jif = new JInternalFrame();
       ...
       // jif.setContentPane(new ImageScroller(icon1, 0, windowCount));
         try
        {
         obj4=new BarChart3DDemo3Lab("lab_use"); 
        }
        catch(Exception ex)
        {
            ex.printStackTrace();
        }
        jif.add(obj4.getchart1());
        windowCount++;
    ...
    public JInternalFrame createInternalFramePalette() {
        ...
        // *************************************
      //  JButton b1 = new JButton("Lab Analysis");
        JButton b2 = new JButton("Today Data Usage Analysis Graph");
        JButton b3 = new JButton("Month Data Usage Analysis Graph");
   ...
   */
        b2.addActionListener(new ActionListener() {
         ...
         b3.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
               JInternalFrame frame1 = createInternalFrame2(icon1, FIRST_FRAME_LAYER, 1, 1);
               frame1.setBounds(FRAME0_X, FRAME0_Y, FRAME0_WIDTH, FRAME0_HEIGHT);
               frame1.setFrameIcon(icon1);
            }
        });
