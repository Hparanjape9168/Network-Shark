...
public class RightPanelLogin extends JPanel 
{
...
//    private schedulefinal sPanel = null;   //update-delete-insert seadual
  //  private screentimer timePanel = null;  //screenshot timer
    ...
    public RightPanelLogin(Component aParent) {
...
//        login = new admin_login();
        ...
        {
            Logger.getLogger(RightPanelLogin.class.getName()).log(Level.SEVERE, null, ex);
