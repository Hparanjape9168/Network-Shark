...
public class internalFramePanel2 extends JPanel {
...
//    test_images object =new test_images();        //database display 
   ...
   //  hell obj2=new hell();                //display graph
    ...
    public internalFramePanel2() {
        super(new BorderLayout());
        init();
    }
    
    private void init() {
        setName("snapshot_display");
        initControls();
    }
    
    private void initControls() {
        icon1 = ImageHelper.loadImage("logo.jpg");
...
//        jif.add(object);
    ...
    public JInternalFrame createInternalFramePalette() {
        ...
        // *************************************
        JButton b1 = new JButton("SNAPSHOT FRAME");
